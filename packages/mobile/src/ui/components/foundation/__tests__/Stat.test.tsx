...
describe("Stat", () => {
  it("renders the value in the numeric family with tabular figures", () => {
    ...
    // Divvy Up renders numerics in Hanken Grotesk with tabular figures
    // (mirrors the web app's `.dd-num` treatment) — no separate mono face.
    expect(String(flat.fontFamily ?? "")).toMatch(/Hanken/i);
  });
